...
class ProblemDetails(object):
    ...
    def status(self):
        ...
        Conveying the HTTP status code.  # noqa: E501
    ...
    def type(self):
        ...
        A URL to a document describing the error condition (optional, and \"about:blank\" is assumed if none is provided; should resolve to a human-readable document).  # noqa: E501
